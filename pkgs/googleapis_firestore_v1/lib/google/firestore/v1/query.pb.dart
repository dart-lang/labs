...
class StructuredQuery_Filter extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(1)
  set compositeFilter(StructuredQuery_CompositeFilter v) { $_setField(1, v); }
  @$pb.TagNumber(1)
  ...
  @$pb.TagNumber(2)
  set fieldFilter(StructuredQuery_FieldFilter v) { $_setField(2, v); }
  @$pb.TagNumber(2)
  ...
  @$pb.TagNumber(3)
  set unaryFilter(StructuredQuery_UnaryFilter v) { $_setField(3, v); }
  @$pb.TagNumber(3)
...
class StructuredQuery_CompositeFilter extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(1)
  set op(StructuredQuery_CompositeFilter_Operator v) { $_setField(1, v); }
  @$pb.TagNumber(1)
...
class StructuredQuery_FieldFilter extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(1)
  set field_1(StructuredQuery_FieldReference v) { $_setField(1, v); }
  @$pb.TagNumber(1)
  ...
  @$pb.TagNumber(2)
  set op(StructuredQuery_FieldFilter_Operator v) { $_setField(2, v); }
  @$pb.TagNumber(2)
  ...
  @$pb.TagNumber(3)
  set value($1.Value v) { $_setField(3, v); }
  @$pb.TagNumber(3)
...
class StructuredQuery_UnaryFilter extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(1)
  set op(StructuredQuery_UnaryFilter_Operator v) { $_setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasOp() => $_has(0);
  @$pb.TagNumber(1)
  void clearOp() => $_clearField(1);
  ...
  @$pb.TagNumber(2)
  set field_2(StructuredQuery_FieldReference v) { $_setField(2, v); }
  @$pb.TagNumber(2)
...
class StructuredQuery_Order extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(2)
  set direction(StructuredQuery_Direction v) { $_setField(2, v); }
  @$pb.TagNumber(2)
...
class StructuredQuery_FindNearest extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(1)
  set vectorField(StructuredQuery_FieldReference v) { $_setField(1, v); }
  @$pb.TagNumber(1)
  ...
  @$pb.TagNumber(2)
  set queryVector($1.Value v) { $_setField(2, v); }
  @$pb.TagNumber(2)
  ...
  @$pb.TagNumber(3)
  set distanceMeasure(StructuredQuery_FindNearest_DistanceMeasure v) { $_setField(3, v); }
  @$pb.TagNumber(3)
  ...
  @$pb.TagNumber(4)
  set limit($14.Int32Value v) { $_setField(4, v); }
  @$pb.TagNumber(4)
  ...
  @$pb.TagNumber(6)
  set distanceThreshold($14.DoubleValue v) { $_setField(6, v); }
  @$pb.TagNumber(6)
...
class StructuredQuery extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(1)
  set select(StructuredQuery_Projection v) { $_setField(1, v); }
  @$pb.TagNumber(1)
  ...
  @$pb.TagNumber(3)
  set where(StructuredQuery_Filter v) { $_setField(3, v); }
  @$pb.TagNumber(3)
  ...
  @$pb.TagNumber(5)
  set limit($14.Int32Value v) { $_setField(5, v); }
  @$pb.TagNumber(5)
  ...
  @$pb.TagNumber(7)
  set startAt(Cursor v) { $_setField(7, v); }
  @$pb.TagNumber(7)
  ...
  @$pb.TagNumber(8)
  set endAt(Cursor v) { $_setField(8, v); }
  @$pb.TagNumber(8)
  ...
  @$pb.TagNumber(9)
  set findNearest(StructuredQuery_FindNearest v) { $_setField(9, v); }
  @$pb.TagNumber(9)
...
class StructuredAggregationQuery_Aggregation_Count extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(1)
  set upTo($14.Int64Value v) { $_setField(1, v); }
  @$pb.TagNumber(1)
...
class StructuredAggregationQuery_Aggregation extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(1)
  set count(StructuredAggregationQuery_Aggregation_Count v) { $_setField(1, v); }
  @$pb.TagNumber(1)
  ...
  @$pb.TagNumber(2)
  set sum(StructuredAggregationQuery_Aggregation_Sum v) { $_setField(2, v); }
  @$pb.TagNumber(2)
  ...
  @$pb.TagNumber(3)
  set avg(StructuredAggregationQuery_Aggregation_Avg v) { $_setField(3, v); }
  @$pb.TagNumber(3)
...
class StructuredAggregationQuery extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(1)
  set structuredQuery(StructuredQuery v) { $_setField(1, v); }
  @$pb.TagNumber(1)
