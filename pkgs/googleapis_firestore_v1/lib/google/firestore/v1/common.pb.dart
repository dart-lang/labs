...
class Precondition extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(2)
  set updateTime($6.Timestamp v) { $_setField(2, v); }
  @$pb.TagNumber(2)
...
class TransactionOptions_ReadOnly extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(2)
  set readTime($6.Timestamp v) { $_setField(2, v); }
  @$pb.TagNumber(2)
...
class TransactionOptions extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(2)
  set readOnly(TransactionOptions_ReadOnly v) { $_setField(2, v); }
  @$pb.TagNumber(2)
  ...
  @$pb.TagNumber(3)
  set readWrite(TransactionOptions_ReadWrite v) { $_setField(3, v); }
  @$pb.TagNumber(3)
