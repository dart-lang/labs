...
@ffi.Native<ffi.Int Function(ffi.Pointer<DIR>)>(symbol: 'my_closedir')
...
/// <errno.h>
@ffi.Native<ffi.Void Function(ffi.Int)>(symbol: 'my_seterrno')
external void seterrno(int err);

@ffi.Native<ffi.Int Function()>(symbol: 'my_errno')
external int errno();
...
@ffi.Native<ffi.Int Function(ffi.Int, ffi.Pointer<Stat>)>(symbol: 'my_fstat')
...
/// <string.h>
@ffi.Native<ffi.Pointer<ffi.Char> Function(ffi.Int)>(symbol: 'my_strerror')
external ffi.Pointer<ffi.Char> strerror(int errnum);

/// <unistd.h>
@ffi.Native<ffi.Int Function(ffi.Int)>(symbol: 'my_close')
